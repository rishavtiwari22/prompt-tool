...
//         <div 
//           className="bg-gray-700 rounded-xl shadow-2xl w-full max-w-2xl pointer-events-auto transform transition-all duration-300"
//           onClick={(e) => e.stopPropagation()}
//         >
//           {/* Header */}
//           <div className="flex items-center justify-between px-6 py-4 border-b border-gray-600">
//             <h4 className="text-white text-2xl sm:text-3xl font-normal" style={{ fontFamily: "'Patrick Hand SC', cursive" }}>
//               RULES
//             </h4>
//             <button
//               onClick={onClose}
...
//                 1
//               </div>
//               <p className="text-gray-200 text-base sm:text-lg leading-relaxed pt-1" style={{ fontFamily: "'Neucha', cursive" }}>
