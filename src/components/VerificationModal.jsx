...
import { X, Eye, EyeOff, Sparkles, CheckCircle2 } from "lucide-react";
        ...
        {!showSuccess ? (
          <>
            ...
            <div className="mb-6 text-center">
              <div className="mb-2 inline-block rounded-full bg-purple-100 p-3">
                <Sparkles className="h-6 w-6 text-purple-600" />
              </div>
              <h2 className="mb-2 text-2xl font-bold">Unlock Your Magic Pass</h2>
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full rounded-lg border border-gray-300 px-4 py-2 transition-all duration-300 hover:border-purple-400 focus:border-purple-500 focus:outline-none focus:ring-2 focus:ring-purple-200 transform focus:scale-[1.02]"
          ...
          <div className="text-center py-8">
            ...
            <h2 className="text-2xl font-bold mb-4 text-green-600">You're in!</h2>
            <p className="mb-6">
              <span className="font-bold text-green-600">Success!</span>{" "}
              You've unlocked the{" "}
              <span className="font-bold text-purple-600">AI Prompt Expert pass</span>{" "}
              as part of{" "}
              <span className="font-bold">
                <span className="text-orange-500">Nav</span>
                <span className="text-black">gurukul</span>'s Program
              </span>.
            </p>
            <button
              type="button"
              className="w-full rounded-lg bg-green-600 px-4 py-3 text-white font-semibold transition-all duration-300 transform hover:scale-[1.02] hover:bg-green-700 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-green-200"
              onClick={async () => {
