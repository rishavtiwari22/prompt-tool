...
//                           isUnlocked
//                             ? "hover:scale-105 sm:hover:scale-110 hover:bg-purple-50"
//                             : ""
//                         }`}
//                         style={{ willChange: "transform" }}
//                         aria-disabled={!isUnlocked}
...
//                 className="rounded-lg flex items-center justify-center hover:scale-105 transition-all duration-200"
//                 style={{ willChange: "transform" }}
//               >
//                 <img
//                   src={rulesIcon}
