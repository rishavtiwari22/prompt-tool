...
//       {/* Hamburger Menu Button (Mobile Only) - Moved to right side */}
//       <button 
...
//       <div className="hidden md:flex items-center justify-center flex-1 mx-2 sm:mx-4 ml-12 md:ml-40 lg:ml-58">
